...
import CardSeriesTop from './cardSeries/CardSeriesTop'
...
const SeriesTop = () => {
    ...
    useEffect(() => {
        const url = `
        https://api.themoviedb.org/3/tv/top_rated?api_key=c3d737df0f14dab49e5201c9bd5a331f&language=en-EN&page=${page}`;
        axios
            .get(url)
            .then((res) => setseriesTopRated(res.data))
    ...
    return (
        <div className='allDiv__container'>
            ...
            <div className='allDiv__movement'>
                ...
                {
                    seriesTopRated?.results.map(serieTopRated => (
                        <CardSeriesTop
                            key={serieTopRated.id}
                            serieTopRated={serieTopRated}
