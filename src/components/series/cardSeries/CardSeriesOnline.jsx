        ...
        <div style={styleMovent} className='allCard__container'>
            ...
            <header className='allCard__header' >
                <div className='allCard__imgContainer'>
                    <img onMouseOver={mouseSond} onMouseOut={() => { setsond(false) }} onClick={handleClick} className='allCard_img' src={`${urlImage}${serieOnline.poster_path ? serieOnline.poster_path : serieOnline.backdrop_path}`} alt="" />
                </div>
            </header>
        </div>
    )
