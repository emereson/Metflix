        ...
        <div style={styleMovent} className='allCard__container'>
            ...
            <header className='allCard__header' >
                <div className='allCard__imgContainer' >
                    <img onMouseOver={mouseSond} onMouseOut={() => { setsond(false) }} onClick={handleClick} className='allCard_img' src={`${urlImage}${movieAnime.poster_path ? movieAnime.poster_path : movieAnime.backdrop_path}`} alt="" />
                </div>
            </header >
        </div >
    )
